...
var FlightsService = /** @class */ (function () {
    function FlightsService(http) {
        this.http = http;
        this.reservations = "http://localhost:8080/reservations";
    }
    FlightsService.prototype.searchFlights = function (from, to, date) {
        ...
        var url = this.reservations + "/search/" + from + "/" + to + "/" + dt;
    ...
    FlightsService.prototype.searchAllFlights = function (from, to, outdate, indate) {
        ...
        var url1 = this.reservations + "/search/" + from + "/" + to + "/" + outDt;
        var url2 = this.reservations + "/search/" + to + "/" + from + "/" + inDt;
    ...
    FlightsService.prototype.book = function (flightId, passenger, address) {
        ...
        var url = this.reservations + "/book";
...
module.exports = __webpack_require__(/*! /Users/hmohamed/github/agilehandy.io/RA-OAuth2-Gen1/agency-ui/src/main.ts */"./src/main.ts");
